# HospitalBMySQLToLanding code for created by Ravi
...
GCS_BUCKET = "healthcare-bucket-26082025"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://34.56.228.243:3306/hospital-b-db?useSSL=false&allowPublicKeyRetrieval=true",
...
def save_logs_to_bigquery():
    ...
    if log_entries:
        # Define schema explicitly to avoid ValueError
...
for row in config_df.collect():
    if row["is_active"].strip() == '1' and row["datasource"].strip().lower() == "hospital_b_db":
